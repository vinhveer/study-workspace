...
file_yeu_cau_path = 'chinh sua hoan tat moto Nha Trang (40539).xlsx'
merge_output_path = 'filtered_merged_file_old.xlsx'
...
if os.path.exists(file_yeu_cau_path) and os.path.exists(merge_output_path):
    ...
    duplicate_entries.to_excel('D:/Desktop/duplicate_entries.xlsx', index=False)
    print("Duplicate entries saved to D:/Desktop/duplicate_entries.xlsx")
    ...
    unique_entries.to_excel('D:/Desktop/file_yeu_cau_merged.xlsx', index=False)
    print("Unique entries saved to D:/Desktop/file_yeu_cau_merged.xlsx")
